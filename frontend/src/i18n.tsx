...
const translations = {
    ...
    'tpa.reservoir': { pt: 'TPA Reservatório', en: 'TPA Reservoir', ja: 'TPA貯水槽' },
    'tpa.safetyMargin': { pt: 'Margem de Segurança (Bomba TPA)', en: 'Safety Margin (TPA Pump)', ja: '安全マージン（TPAポンプ）' },
    'tpa.safetyHint': { pt: 'Deixe sempre X ml de água no fundo do reservatório', en: 'Always leave X ml of water in the reservoir', ja: '貯水槽の底に常にX mlの水を残す' },
    ...
    'config.otaTitle': { pt: 'ATUALIZAÇÃO DO SISTEMA (OTA)', en: 'SYSTEM UPDATE (OTA)', ja: 'システム更新 (OTA)' },
    'config.otaSelect': { pt: 'Selecione o arquivo .bin', en: 'Select .bin file', ja: '.bin ファイルを選択' },
    'config.otaUpload': { pt: 'ATUALIZAR FIRMWARE', en: 'UPDATE FIRMWARE', ja: 'ファームウェア更新' },
    'config.otaUploading': { pt: 'Enviando...', en: 'Uploading...', ja: '送信中...' },
    'config.otaSuccess': { pt: 'Atualização concluída! Reiniciando...', en: 'Update complete! Rebooting...', ja: '更新完了！再起動中...' },
    'config.otaError': { pt: 'Erro na atualização!', en: 'Update failed!', ja: '更新エラー！' },
