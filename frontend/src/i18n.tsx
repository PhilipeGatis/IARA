...
const translations = {
    ...
    'tpa.reservoirMissing': { pt: 'Volume do reservatório', en: 'Reservoir volume', ja: '貯水槽の容量' },
    'tpa.pctMissing': { pt: 'Volume da TPA (%)', en: 'Water change volume (%)', ja: '水換え量（％）' },
    'tpa.sensorMissing': { pt: 'Calibração do sensor ultrassônico', en: 'Ultrasonic sensor calibration', ja: '超音波センサーのキャリブレーション' },
    'tpa.drainPumpMissing': { pt: 'Calibração da bomba de Dreno', en: 'Drain pump calibration', ja: '排水ポンプのキャリブレーション' },
    'tpa.refillPumpMissing': { pt: 'Calibração da bomba de Recalque', en: 'Refill pump calibration', ja: '給水ポンプのキャリブレーション' },
    'tpa.safetyMlMissing': { pt: 'Margem de segurança do reservatório', en: 'Reservoir safety margin', ja: '貯水槽の安全マージン' },
    ...
    'tpa.recalibrateFlow': { pt: '⚙ Recalibrar vazão', en: '⚙ Recalibrate flow', ja: '⚙ 流量を再キャリブレーション' },
